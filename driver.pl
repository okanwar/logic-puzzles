...
system("./dlc -z -o zap-puzzles.c puzzles.c") == 0
...
system("./dlc -Z -o Zap-puzzles.c save-puzzles.c") == 0
    or die "$0: ERROR: dlc unable to generated Zapped puzzles.c file.\n";
...
$status = system("./dlc -W1 -e zap-puzzles.c > dlc-opcount.out 2>&1");
if ($status != 0) {
